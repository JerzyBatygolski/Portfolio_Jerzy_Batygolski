...
namespace Project1 {
	...
	/// Summary for Traffic
	/// </summary>
	public ref class Traffic : public System::Windows::Forms::Form
	{
	public:
		Traffic(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Traffic::typeid));
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &Traffic::timer1_Tick);
			// 
			// label1
			// 
			...
			this->btn_stop->Click += gcnew System::EventHandler(this, &Traffic::btn_stop_Click);
			// 
			// btn_reset
			// 
			...
			this->btn_reset->Click += gcnew System::EventHandler(this, &Traffic::btn_reset_Click);
			// 
			// menuStrip1
			// 
			...
			this->zieloneToolStripMenuItem->MouseEnter += gcnew System::EventHandler(this, &Traffic::zieloneToolStripMenuItem_MouseEnter_1);
			// 
			// toolStripTextBox1
			// 
			...
			this->toolStripTextBox1->TextChanged += gcnew System::EventHandler(this, &Traffic::toolStripTextBox1_TextChanged_1);
			// 
			...
			this->¿ó³teToolStripMenuItem->MouseEnter += gcnew System::EventHandler(this, &Traffic::¿ó³teToolStripMenuItem_MouseEnter_1);
			// 
			// toolStripTextBox2
			// 
			...
			this->toolStripTextBox2->TextChanged += gcnew System::EventHandler(this, &Traffic::toolStripTextBox2_TextChanged_1);
			// 
			...
			this->przerwaToolStripMenuItem->MouseEnter += gcnew System::EventHandler(this, &Traffic::przerwaToolStripMenuItem_MouseEnter_1);
			// 
			// toolStripTextBox3
			// 
			...
			this->toolStripTextBox3->TextChanged += gcnew System::EventHandler(this, &Traffic::toolStripTextBox3_TextChanged_1);
			// 
			...
			this->resetujToolStripMenuItem->Click += gcnew System::EventHandler(this, &Traffic::resetujToolStripMenuItem_Click_1);
			// 
			...
			this->toolStripTextBox4->TextChanged += gcnew System::EventHandler(this, &Traffic::toolStripTextBox4_TextChanged);
			// 
			// picture_car
			// 
			...
			this->Name = L"Traffic";
			this->Text = L"Traffic";
			this->Load += gcnew System::EventHandler(this, &Traffic::Traffic);
...
#pragma endregion
		...
		//£adowanie formatki
private: System::Void Traffic_Load(System::Object^  sender, System::EventArgs^  e) {
		meter = 0;
		global_meter = 0;
		phase = 1;
		number_of_cars = 0;
